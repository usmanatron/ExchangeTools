...
.\packages\OpenCover.4.5.3522\OpenCover.Console.exe -register:user -target:".\runTests.cmd" -output:.\opencover\codecoverage\coveragereport.xml -log:All -filter:"+[*]* -[ExchangeOofScheduler.*.Tests]*"
